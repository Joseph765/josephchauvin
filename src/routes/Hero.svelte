<script>
    import { Button, Container, Flex, Text } from "$lib/components";
...
<section id="hero">
    <Container size="xl">
        <Flex direction="column" gap="l" align="center">
            <iframe style="display: block; max-width: 1000px; width: calc(100vw - 4rem); height: auto; aspect-ratio: 16/9; padding-inline: 0rem;" src="https://www.youtube.com/embed/KvZztfj-aA4?si=mCjWf5R-va-2KVx-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
